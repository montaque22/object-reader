...
function ObjectReader(source) {
    ...
    this.getSource = function (asArray) {
        ...
        var keys = asArray && !!obj && (0, _keys2.default)(obj) || [];
    ...
    this.inspect = function (propertyString, defaultProperty) {
        ...
        if ((intermediate === undefined || intermediate === null) && defaultProperty !== undefined) return defaultProperty;
        return intermediate;
    };
    ...
    this.inject = function (keyString, value, isStrict) {
        ...
        function setup(data, key) {
            var prevKey = ObjectReader.prevKey;
            ...
            if (prevKey === undefined) {
                ...
                if ((0, _typeof3.default)(data[key]) === 'object') return data[key];
        ...
        function helper(source, keys, input) {
            ...
            if (isStrict && isInvalid(data)) return false;

            // We can create new properties (data == null | undefined) or add to existing objects (data = object)
            else if (data === null || data === undefined || (typeof data === 'undefined' ? 'undefined' : (0, _typeof3.default)(data)) === 'object') {
    ...
    function isInvalid(test) {
        return test === undefined || test === null || !((typeof test === 'undefined' ? 'undefined' : (0, _typeof3.default)(test)) === 'object');
    }
    ...
    function objToString(obj) {
        var ndeep = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
        ...
        switch (typeof obj === 'undefined' ? 'undefined' : (0, _typeof3.default)(obj)) {
            ...
            case "object":
                ...
                return '{['[+isArray] + (0, _keys2.default)(obj).map(function (key) {
    ...
    function verifySource(source, suppressError) {
        ...
        switch (typeof source === 'undefined' ? 'undefined' : (0, _typeof3.default)(source)) {
            case 'number':
            case 'string':
                if (suppressError) return false;
                throw new Error((typeof source === 'undefined' ? 'undefined' : (0, _typeof3.default)(source)) + ' is not a acceptable parameter for the ObjectReader');
            default:
                return true;
        }
    }
